...
lv_obj_t * _lv_demo_music_main_create(lv_obj_t * parent)
{
    ...
    lv_obj_align(ctrl_box, NULL, LV_ALIGN_IN_BOTTOM_MID, 10, -15);
#else
	...
	lv_obj_align(time_obj, slider_obj, LV_ALIGN_OUT_RIGHT_MID, -1, 0);
    ...
    lv_obj_t * logo = lv_img_create(main_cont, NULL);
    ...
    lv_obj_t * title = lv_label_create(main_cont, NULL);
