...
#include "100ask_music_main.h"
#include "100ask_music_list.h"
...
void lv_100ask_music_player(void)
{
    ...
    lv_obj_t *  back_btn = add_back(back_to_home_event_cb);
    lv_obj_fade_in(back_btn, 0 , 3000);
...
static void auto_step_cb(lv_task_t * task)
{
    ...
    case 40: {
          ...
          lv_label_set_text(attr, "Copyright 2020 100ask All Rights Reserved. | www.100ask.net | bbs.100ask.net");
