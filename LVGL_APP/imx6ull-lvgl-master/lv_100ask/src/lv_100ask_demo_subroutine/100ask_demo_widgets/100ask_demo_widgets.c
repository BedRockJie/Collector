...
void lv_100ask_demo_widgets(void)
{
    lv_100ask_demo_anim_out_all(lv_scr_act(), 0);
    lv_100ask_demo_anim_bg(0, LV_100ASK_DEMO_GRAY, LV_100ASK_DEMO_BG_FULL); // µ÷ÕûÒ³Ãæ±³¾°  lv_color_hex(0xf3f8fe)

    tv = lv_tabview_create(lv_scr_act(), NULL);
    lv_obj_clean_style_list(tv, LV_OBJ_PART_MAIN);
#if LV_USE_THEME_MATERIAL
