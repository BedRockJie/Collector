 ...
 *      INCLUDES
 *********************/
#include "lv_100ask_demo_theme.h"
...
static lv_style_t style_chinese_character;
...
static void basic_init(void)
{
    ...
    lv_style_set_bg_color(&style_bg, LV_STATE_DEFAULT, LV_100ASK_DEMO_LIGHT);
    ...
    lv_style_set_value_color(&style_box, LV_STATE_DEFAULT, LV_100ASK_DEMO_BLUE);
    ...
    lv_style_set_border_color(&style_box_border, LV_STATE_DEFAULT, LV_100ASK_DEMO_GRAY);
    lv_style_set_text_color(&style_box, LV_STATE_DEFAULT, LV_100ASK_DEMO_BLUE);


    lv_style_init(&style_title);
    lv_style_set_text_color(&style_title, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    lv_style_set_text_font(&style_title, LV_STATE_DEFAULT, theme.font_subtitle);

	/* 显示中文 */
    lv_style_init(&style_chinese_character);
    lv_style_set_text_color(&style_chinese_character, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    lv_style_set_text_font(&style_chinese_character, LV_STATE_DEFAULT, theme.font_small);


    lv_style_init(&style_label_white);
    lv_style_set_text_color(&style_label_white, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);

    lv_style_init(&style_btn);
    lv_style_set_radius(&style_btn, LV_STATE_DEFAULT, 10);
    lv_style_set_bg_opa(&style_btn, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_btn, LV_STATE_DEFAULT, LV_100ASK_DEMO_BLUE);
    lv_style_set_bg_color(&style_btn, LV_STATE_PRESSED, lv_color_darken(LV_100ASK_DEMO_BLUE, LV_OPA_20));
    lv_style_set_text_color(&style_btn, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    lv_style_set_value_color(&style_btn, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    ...
    lv_style_set_border_color(&style_btn_border, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    ...
    lv_style_set_bg_color(&style_btn_border, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    lv_style_set_bg_color(&style_btn_border, LV_STATE_PRESSED, LV_100ASK_DEMO_WHITE);
    lv_style_set_text_color(&style_btn_border, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    lv_style_set_value_color(&style_btn_border, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    lv_style_set_transition_prop_3(&style_btn_border, LV_STATE_DEFAULT, LV_STYLE_BG_OPA);

    lv_style_init(&style_icon);
    lv_style_set_text_color(&style_icon, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    ...
    lv_style_set_value_color(&style_back, LV_STATE_DEFAULT, LV_100ASK_DEMO_GREEN);
    lv_style_set_value_color(&style_back, LV_STATE_PRESSED, LV_100ASK_DEMO_LIGHT_GRAY);
    ...
    lv_style_set_bg_color(&style_scrollbar, LV_STATE_DEFAULT, LV_100ASK_DEMO_LIGHT_GRAY);
    ...
    lv_style_set_bg_color(&style_list_btn, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_PRESSED, LV_100ASK_DEMO_LIGHT_GRAY);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED, LV_100ASK_DEMO_GRAY);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED, lv_color_darken(LV_100ASK_DEMO_GRAY, LV_OPA_20));
    lv_style_set_text_color(&style_list_btn, LV_STATE_DEFAULT, LV_100ASK_DEMO_BLUE);
    lv_style_set_text_color(&style_list_btn, LV_STATE_PRESSED, lv_color_darken(LV_100ASK_DEMO_BLUE, LV_OPA_20));
    lv_style_set_text_color(&style_list_btn, LV_STATE_CHECKED, LV_100ASK_DEMO_WHITE);
    lv_style_set_text_color(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED, LV_100ASK_DEMO_WHITE);
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_DEFAULT, LV_100ASK_DEMO_BLUE);
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_PRESSED, lv_color_darken(LV_100ASK_DEMO_BLUE, LV_OPA_20));
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_CHECKED, LV_100ASK_DEMO_WHITE);
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED, LV_100ASK_DEMO_WHITE);
    ...
    lv_style_set_shadow_color(&style_ddlist_list, LV_STATE_DEFAULT, LV_100ASK_DEMO_GRAY);

    lv_style_init(&style_ddlist_selected);
    lv_style_set_bg_opa(&style_ddlist_selected, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_DEFAULT, LV_100ASK_DEMO_BLUE);
    lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_PRESSED, LV_100ASK_DEMO_LIGHT_GRAY);
    lv_style_set_text_color(&style_ddlist_selected, LV_STATE_PRESSED, lv_color_darken(LV_100ASK_DEMO_GRAY, LV_OPA_20));

    lv_style_init(&style_sw_bg);
    lv_style_set_bg_opa(&style_sw_bg, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_sw_bg, LV_STATE_DEFAULT, LV_100ASK_DEMO_LIGHT_GRAY);
    lv_style_set_radius(&style_sw_bg, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);
    lv_style_set_value_color(&style_sw_bg, LV_STATE_DEFAULT, LV_100ASK_DEMO_BLUE);

    lv_style_init(&style_sw_indic);
    lv_style_set_bg_opa(&style_sw_indic, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_sw_indic, LV_STATE_DEFAULT, LV_100ASK_DEMO_GREEN);

    lv_style_init(&style_sw_knob);
    lv_style_set_bg_opa(&style_sw_knob, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_sw_knob, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    ...
    lv_style_set_bg_color(&style_slider_knob, LV_STATE_DEFAULT, LV_100ASK_DEMO_BLUE);
    lv_style_set_border_color(&style_slider_knob, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
    ...
    lv_style_set_line_color(&style_arc_indic, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);

    lv_style_init(&style_arc_bg);
    lv_style_set_value_color(&style_arc_bg, LV_STATE_DEFAULT, LV_100ASK_DEMO_WHITE);
...
static void theme_apply(lv_obj_t * obj, lv_theme_style_t name)
{
    ...
    switch(name_int) {
        ...
        case LV_100ASK_DEMO_THEME_BOX_BORDER:
            lv_obj_clean_style_list(obj, LV_OBJ_PART_MAIN);
            list = lv_obj_get_style_list(obj, LV_OBJ_PART_MAIN);
            _lv_style_list_add_style(list, &style_box);
        ...
        case LV_100ASK_DEMO_THEME_BTN_CIRCLE:
        ...
        case LV_100ASK_DEMO_THEME_BTN_BORDER:
            lv_obj_clean_style_list(obj, LV_BTN_PART_MAIN);
            list = lv_obj_get_style_list(obj, LV_BTN_PART_MAIN);
            _lv_style_list_add_style(list, &style_btn);
        ...
        case LV_100ASK_DEMO_THEME_BTN_BACK:
            lv_obj_clean_style_list(obj, LV_BTN_PART_MAIN);
            list = lv_obj_get_style_list(obj, LV_BTN_PART_MAIN);
        ...
        case LV_100ASK_DEMO_THEME_ICON:
            lv_obj_clean_style_list(obj, LV_IMG_PART_MAIN);
            list = lv_obj_get_style_list(obj, LV_IMG_PART_MAIN);
        ...
        case LV_100ASK_DEMO_THEME_TITLE:
            lv_obj_clean_style_list(obj, LV_LABEL_PART_MAIN);
            list = lv_obj_get_style_list(obj, LV_LABEL_PART_MAIN);
            _lv_style_list_add_style(list, &style_title);
            break;

        case LV_100ASK_DEMO_THEME_LABEL_WHITE:
            lv_obj_clean_style_list(obj, LV_LABEL_PART_MAIN);
            list = lv_obj_get_style_list(obj, LV_LABEL_PART_MAIN);
		...
		case LV_100ASK_DEMO_THEME_CHINESE_CHARACTER:
            lv_obj_clean_style_list(obj, LV_LABEL_PART_MAIN);
            list = lv_obj_get_style_list(obj, LV_LABEL_PART_MAIN);
            _lv_style_list_add_style(list, &style_chinese_character);
            break;
